    ...
    console.log(info)
     ...
     return info ?  (
        <div style={{
            ...
            >
                ...
                <div className='content ml-[5%] text-white'>
                    ...
                    <div className='mt-3 mb-5 flex items-center gap-x-5'>
                        ...
                        <h1 className='w-[60px] text-2xl font-semibold leading-6'>User Score</h1>
                    ...
                    <h1 className='text-2xl mb-3 mt-5'>Series Translated</h1> 
                    <p className='mb-10'>{info.translations.join(", ")}</p>  

                    <Link 
                        className='p-5 bg-[#6556CD] rounded-lg ml-150' 
                        to={`${pathname}/trailer`}>
            ...
            {/* Part 3 Available on OTT */}
            <div className='w-[80%] flex flex-col gap-y-5 mt-[1%] mb-8'>
                    {
                        info.watchproviders && 
                        info.watchproviders.flatrate && 
            ...
            <div className='w-[100%] flex overflow-y-hidden mb-5 p-5 gap-x-5'>
                {info.detail.seasons.length > 0 ? info.detail.seasons.map((s,i) =>(
                    <div>
                        <img 
                            className='shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] min-w-[15vw] h-[30vh] object-cover' 
                            src={`https://image.tmdb.org/t/p/original/${s.poster_path}`} 
                            alt="" 
                        />

                        <h1 className='ml-15 text-2xl text-zinc-300 mt-3 font-semibold'>
                            {s.name}
                        </h1>
                    </div>
            ...
            <hr className='mt-10 mb-5 border-none h-[2px] bg-zinc-500' />
            <h1 className='text-3xl font-bold text-white'>Recommendations & Similar Results</h1>
