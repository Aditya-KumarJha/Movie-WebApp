...
const Header = ({data}) => {
    ...
    return (
        <div style={{
            ...
            <p 
                className='w-[70%] mt-3 mb-3 text-white'>{data.overview.slice(0, 200)}... 
            ...
            <Link to={`/${data.media_type}/details/${data.id}/trailer`} className='p-4 mt-5 rounded text-white bg-[#6556CD]'>Watch Trailer</Link>
